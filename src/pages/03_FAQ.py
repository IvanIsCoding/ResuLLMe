...
with st.expander(
    "**Can I store my OpenAI/Gemini API Key instead of manually re-entering it?**"
):
    st.markdown(
        """
...
with st.expander(
    "**I want to use my own custom format to render my résumé. Is this possible?**"
):
    st.markdown(
        """
...
with st.expander(
    "**There is information on my résumé that is not accurate. How do I fix it?**"
):
    st.markdown(
        """
